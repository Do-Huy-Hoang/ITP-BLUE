...
<div class="card">
    ...
    <div class="info">
        <div class="row">
            <div class="col-7">
                ...
                <span id="details">{{ $order->created_at->format('d F Y') }}</span>
            </div>
            <div class="col-5 pull-right">
                <span id="heading">Order No.</span><br>
                <span id="details">{{ $order->order_number }}</span>
            </div>
        </div>
    </div>
    <div class="pricing">
        @foreach ($order->orderDetails as $detail)
            <div class="row">
                ...
                <div class="col-3">
                    <span id="price">${{ number_format($detail->ordd_product_price, 2) }}</span>
                </div>
            </div>
        @endforeach
        <div class="row">
            ...
            <div class="col-3">
                <span id="price">${{ $order->ord_ship }}</span>
            </div>
        </div>
    </div>
    <div class="total">
        <div class="row">
            <div class="col-9"></div>
            <div class="col-3"><big>${{ $order->ord_total }}</big></div>
        </div>
    </div>
    <div class="tracking">
    ...
    <div class="footer">
        <div class="row">
            ...
            <div class="col-10">Want any help? Please &nbsp;<a href="#">contact us</a></div>
        </div>
    </div>
</div>